...
- `next-frontend/` — Frontend (Next.js 16, App Router), initialized with the Phase 01–02 auth UI. Out of scope for the Phase 03 backend work.
...
- **Message Queue** (BullMQ over Redis) → video processing job queue (Phase 03)
